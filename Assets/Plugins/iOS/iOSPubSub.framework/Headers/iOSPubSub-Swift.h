...
#ifndef IOSPUBSUB_SWIFT_H
#define IOSPUBSUB_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="iOSPubSub",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9iOSPubSub9GameRelay")
...
SWIFT_PROTOCOL("_TtP9iOSPubSub13SwiftCallback_")
@protocol SwiftCallback
